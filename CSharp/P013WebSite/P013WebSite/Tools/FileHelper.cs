namespace P013WebSite.Tools
{
    ...
    public class FileHelper
    {
        public static async Task<string> FileLoaderAsync(IFormFile formFile, string klasorYolu ="/wwwroot/Img/")
        {
            ...
            string dizin = Directory.GetCurrentDirectory(); // uygulamamızın pc de çalıştığı yeri bize getirriyor.
            ...
            await formFile.CopyToAsync(stream); // IFormFile içerisinden gelen ve asenkron çalışan CopyToAsync Metoduuna dosya yükleme akışımızı gönderdik. ve dosyayı sunucuya kopyaladık.
