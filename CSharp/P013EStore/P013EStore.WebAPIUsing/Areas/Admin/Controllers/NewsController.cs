...
namespace P013EStore.WebAPIUsing.Areas.Admin.Controllers
{
    ...
    public class NewsController : Controller
    {
        ...
        private readonly string _apiAdres = "https://localhost:7106/api/News";
        ...
        {
            ViewBag.ParentId = new SelectList(await _httpClient.GetFromJsonAsync<List<News>>(_apiAdres), "Id", "Name");
            return View();
        }
