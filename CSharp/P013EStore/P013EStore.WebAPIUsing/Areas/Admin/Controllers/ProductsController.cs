...
namespace P013EStore.WebAPIUsing.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        private readonly string _apiAdresKategori = "https://localhost:7106/api/Categories";
        private readonly string _apiAdresMarka = "https://localhost:7106/api/Brands";
        ...
        public async Task<ActionResult> CreateAsync(Product collection, IFormFile? Image, bool? resmiSil)
        {
            try
            {
